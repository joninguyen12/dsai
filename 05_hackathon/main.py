# api/main.py
# REST API for Seattle congestion data — by location, time window, severity
# Queries Supabase. Run: uvicorn api.main:app --reload (from 05_hackathon)
...
# ---------------------------------------------------------------------------
# Readings — by location, time window, severity
# ---------------------------------------------------------------------------
